...
var file_plaid_proto_rawDesc = []byte{
	...
	0x5a, 0x0a, 0x14, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x67, 0x49, 0x74, 0x65, 0x6d,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x42, 0x0a, 0x0d, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x4f, 0x72, 0x67, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x19, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
...
var file_plaid_proto_depIdxs = []int32{
	...
	2, // 2: proto.UpdateOrgItemService.UpdateOrgItem:input_type -> proto.ExchangePlaidReply
	...
	1, // 6: proto.UpdateOrgItemService.UpdateOrgItem:output_type -> proto.ExchangePlaid
...
type UpdateOrgItemServiceClient interface {
	UpdateOrgItem(ctx context.Context, in *ExchangePlaidReply, opts ...grpc.CallOption) (*ExchangePlaid, error)
}
...
func (c *updateOrgItemServiceClient) UpdateOrgItem(ctx context.Context, in *ExchangePlaidReply, opts ...grpc.CallOption) (*ExchangePlaid, error) {
...
type UpdateOrgItemServiceServer interface {
	UpdateOrgItem(context.Context, *ExchangePlaidReply) (*ExchangePlaid, error)
}
...
func (*UnimplementedUpdateOrgItemServiceServer) UpdateOrgItem(context.Context, *ExchangePlaidReply) (*ExchangePlaid, error) {
...
func _UpdateOrgItemService_UpdateOrgItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UpdateOrgItemServiceServer).UpdateOrgItem(ctx, req.(*ExchangePlaidReply))
	}
	return interceptor(ctx, in, info, handler)
}

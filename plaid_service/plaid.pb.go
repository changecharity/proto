...
var file_plaid_proto_depIdxs = []int32{
	0, // 0: proto.CreateExchangePlaidService.CreateExchangePlaid:input_type -> proto.ExchangePlaid
	1, // 1: proto.CreateExchangePlaidService.CreateExchangePlaid:output_type -> proto.ExchangePlaidReply

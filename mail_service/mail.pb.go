...
type HealthCheckResponse struct {
	...
	Status HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=mailproto.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
}
...
var file_mail_proto_rawDesc = []byte{
	...
	0x69, 0x6c, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2e, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12,
	0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05,
	0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x22, 0x25, 0x0a, 0x09, 0x41, 0x75, 0x74, 0x68, 0x52,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0x97,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2c, 0x2e, 0x6d, 0x61, 0x69, 0x6c, 0x70, 0x72, 0x6f,
	...
	,
...
var file_mail_proto_goTypes = []interface{}{
	(HealthCheckResponse_ServingStatus)(0), // 0: mailproto.HealthCheckResponse.ServingStatus
	(*Auth)(nil),                           // 1: mailproto.Auth
	(*AuthReply)(nil),                      // 2: mailproto.AuthReply
	(*HealthCheckRequest)(nil),             // 3: mailproto.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 4: mailproto.HealthCheckResponse
}
var file_mail_proto_depIdxs = []int32{
	0, // 0: mailproto.HealthCheckResponse.status:type_name -> mailproto.HealthCheckResponse.ServingStatus
	1, // 1: mailproto.Mail.Send:input_type -> mailproto.Auth
	3, // 2: mailproto.Health.Check:input_type -> mailproto.HealthCheckRequest
	2, // 3: mailproto.Mail.Send:output_type -> mailproto.AuthReply
	4, // 4: mailproto.Health.Check:output_type -> mailproto.HealthCheckResponse
...
func (c *mailClient) Send(ctx context.Context, in *Auth, opts ...grpc.CallOption) (*AuthReply, error) {
	out := new(AuthReply)
	err := c.cc.Invoke(ctx, "/mailproto.Mail/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Mail_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mailproto.Mail/Send",
	}
...
func (c *healthClient) Check(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mailproto.Health/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Health_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mailproto.Health/Check",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

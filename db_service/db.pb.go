...
var file_db_proto_rawDesc = []byte{
	...
	0x6e, 0x32, 0x55, 0x0a, 0x11, 0x55, 0x73, 0x65, 0x72, 0x53, 0x69, 0x67, 0x6e, 0x55, 0x70, 0x53,
...
var file_db_proto_depIdxs = []int32{
	...
	0,  // 14: proto.UserSignUpService.SendUserSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 15: proto.OrgSignUpService.SendOrgSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 16: proto.CheckUserSignUpService.CheckUserSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 17: proto.CheckOrgSignUpService.CheckOrgSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 18: proto.AuthLoginService.AuthLogin:output_type -> proto.GlobalSuccessReply
	0,  // 19: proto.BeginTransactionWHService.BeginTransactionWH:output_type -> proto.GlobalSuccessReply
	0,  // 20: proto.ConfirmTransferService.ConfirmTransfer:output_type -> proto.GlobalSuccessReply
	7,  // 21: proto.SearchOrgNameService.SearchOrgName:output_type -> proto.OrgNameReply
	0,  // 22: proto.TransferPDFService.TransferPDF:output_type -> proto.GlobalSuccessReply
	0,  // 23: proto.SaveLogoService.SaveLogo:output_type -> proto.GlobalSuccessReply
	11, // 24: proto.GetTransactionsService.GetTransactions:output_type -> proto.GetTransactionsMsgReply
	0,  // 25: proto.UpdateThresholdService.UpdateThreshold:output_type -> proto.GlobalSuccessReply
	15, // 26: proto.GetUsersOrgInfoService.GetUsersOrgInfo:output_type -> proto.UsersOrgInfoReply

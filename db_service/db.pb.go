...
var file_db_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x32, 0x55, 0x0a, 0x11, 0x55, 0x73, 0x65, 0x72, 0x53,
...
var file_db_proto_depIdxs = []int32{
	...
	0, // 8: proto.UserSignUpService.SendUserSignUp:output_type -> proto.GlobalSuccessReply
	0, // 9: proto.OrgSignUpService.SendOrgSignUp:output_type -> proto.GlobalSuccessReply
	0, // 10: proto.CheckUserSignUpService.CheckUserSignUp:output_type -> proto.GlobalSuccessReply
	0, // 11: proto.CheckOrgSignUpService.CheckOrgSignUp:output_type -> proto.GlobalSuccessReply
	0, // 12: proto.AuthLoginService.AuthLogin:output_type -> proto.GlobalSuccessReply
	0, // 13: proto.BeginTransactionWHService.BeginTransactionWH:output_type -> proto.GlobalSuccessReply
	0, // 14: proto.ConfirmTransferService.ConfirmTransfer:output_type -> proto.GlobalSuccessReply
	7, // 15: proto.SearchOrgNameService.SearchOrgName:output_type -> proto.OrgNameReply

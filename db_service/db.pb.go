...
var file_db_proto_rawDesc = []byte{
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x32, 0x55, 0x0a,
...
var file_db_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
...
var file_db_proto_depIdxs = []int32{
	...
	0,  // 31: proto.UserSignUpService.SendUserSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 32: proto.OrgSignUpService.SendOrgSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 33: proto.CheckUserSignUpService.CheckUserSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 34: proto.CheckOrgSignUpService.CheckOrgSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 35: proto.ResendEmailAuthService.ResendEmailAuth:output_type -> proto.GlobalSuccessReply
	0,  // 36: proto.AuthLoginService.AuthLogin:output_type -> proto.GlobalSuccessReply
	0,  // 37: proto.BeginTransactionWHService.BeginTransactionWH:output_type -> proto.GlobalSuccessReply
	0,  // 38: proto.ConfirmTransferService.ConfirmTransfer:output_type -> proto.GlobalSuccessReply
	8,  // 39: proto.SearchOrgNameService.SearchOrgName:output_type -> proto.OrgNameReply
	0,  // 40: proto.TransferPDFService.TransferPDF:output_type -> proto.GlobalSuccessReply
	0,  // 41: proto.SaveLogoService.SaveLogo:output_type -> proto.GlobalSuccessReply
	12, // 42: proto.GetTransactionsService.GetTransactions:output_type -> proto.GetTransactionsMsgReply
	0,  // 43: proto.UpdateThresholdService.UpdateThreshold:output_type -> proto.GlobalSuccessReply
	17, // 44: proto.GetUsersOrgInfoService.GetUsersOrgInfo:output_type -> proto.UsersOrgInfoReply
	18, // 45: proto.GetUsersTotalsService.GetUsersTotals:output_type -> proto.UsersTotalsReply
	19, // 46: proto.GetUsersProfileService.GetUsersProfile:output_type -> proto.UsersProfileReply
	0,  // 47: proto.DeleteUsersBAService.DeleteUsersBA:output_type -> proto.GlobalSuccessReply
	0,  // 48: proto.UpdateUsersBAService.UpdateUsersBA:output_type -> proto.GlobalSuccessReply
	0,  // 49: proto.ValidNewAccService.ValidNewAcc:output_type -> proto.GlobalSuccessReply
	0,  // 50: proto.ValidPassService.ValidPass:output_type -> proto.GlobalSuccessReply
	0,  // 51: proto.ValidKeyService.ValidKey:output_type -> proto.GlobalSuccessReply
	0,  // 52: proto.SendForgotPassService.SendForgotPass:output_type -> proto.GlobalSuccessReply
	0,  // 53: proto.ForgotPassService.ForgotPass:output_type -> proto.GlobalSuccessReply
	0,  // 54: proto.CheckOrgTosAcceptedService.CheckOrgTosAccepted:output_type -> proto.GlobalSuccessReply
	0,  // 55: proto.ResendOrgsTosService.ResendOrgsTos:output_type -> proto.GlobalSuccessReply
	23, // 56: proto.GetDashboardService.GetDashboard:output_type -> proto.Dashboard
	24, // 57: proto.GetTransfersService.GetTransfers:output_type -> proto.OrgsTransfers
	27, // 58: proto.OrgsGetQrService.OrgsGetQr:output_type -> proto.LogoAndQrCode
	27, // 59: proto.OrgsGetLogoService.OrgsGetLogo:output_type -> proto.LogoAndQrCode

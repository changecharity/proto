...
var file_db_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x49, 0x64, 0x32, 0x55, 0x0a, 0x11, 0x55, 0x73, 0x65, 0x72, 0x53, 0x69, 0x67, 0x6e,
...
var file_db_proto_depIdxs = []int32{
	...
	0,  // 20: proto.UserSignUpService.SendUserSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 21: proto.OrgSignUpService.SendOrgSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 22: proto.CheckUserSignUpService.CheckUserSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 23: proto.CheckOrgSignUpService.CheckOrgSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 24: proto.ResendEmailAuthService.ResendEmailAuth:output_type -> proto.GlobalSuccessReply
	0,  // 25: proto.AuthLoginService.AuthLogin:output_type -> proto.GlobalSuccessReply
	0,  // 26: proto.BeginTransactionWHService.BeginTransactionWH:output_type -> proto.GlobalSuccessReply
	0,  // 27: proto.ConfirmTransferService.ConfirmTransfer:output_type -> proto.GlobalSuccessReply
	8,  // 28: proto.SearchOrgNameService.SearchOrgName:output_type -> proto.OrgNameReply
	0,  // 29: proto.TransferPDFService.TransferPDF:output_type -> proto.GlobalSuccessReply
	0,  // 30: proto.SaveLogoService.SaveLogo:output_type -> proto.GlobalSuccessReply
	12, // 31: proto.GetTransactionsService.GetTransactions:output_type -> proto.GetTransactionsMsgReply
	0,  // 32: proto.UpdateThresholdService.UpdateThreshold:output_type -> proto.GlobalSuccessReply
	16, // 33: proto.GetUsersOrgInfoService.GetUsersOrgInfo:output_type -> proto.UsersOrgInfoReply
	17, // 34: proto.GetUsersTotalsService.GetUsersTotals:output_type -> proto.UsersTotalsReply
	18, // 35: proto.GetUsersProfileService.GetUsersProfile:output_type -> proto.UsersProfileReply
	0,  // 36: proto.DeleteUsersBAService.DeleteUsersBA:output_type -> proto.GlobalSuccessReply
	0,  // 37: proto.UpdateUsersBAService.UpdateUsersBA:output_type -> proto.GlobalSuccessReply
	0,  // 38: proto.ValidNewAccService.ValidNewAcc:output_type -> proto.GlobalSuccessReply

...
var file_db_proto_rawDesc = []byte{
	...
	0x6e, 0x67, 0x65, 0x32, 0x55, 0x0a, 0x11, 0x55, 0x73, 0x65, 0x72, 0x53, 0x69, 0x67, 0x6e, 0x55,
...
var file_db_proto_depIdxs = []int32{
	...
	0,  // 12: proto.UserSignUpService.SendUserSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 13: proto.OrgSignUpService.SendOrgSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 14: proto.CheckUserSignUpService.CheckUserSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 15: proto.CheckOrgSignUpService.CheckOrgSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 16: proto.AuthLoginService.AuthLogin:output_type -> proto.GlobalSuccessReply
	0,  // 17: proto.BeginTransactionWHService.BeginTransactionWH:output_type -> proto.GlobalSuccessReply
	0,  // 18: proto.ConfirmTransferService.ConfirmTransfer:output_type -> proto.GlobalSuccessReply
	7,  // 19: proto.SearchOrgNameService.SearchOrgName:output_type -> proto.OrgNameReply
	0,  // 20: proto.TransferPDFService.TransferPDF:output_type -> proto.GlobalSuccessReply
	0,  // 21: proto.SaveLogoService.SaveLogo:output_type -> proto.GlobalSuccessReply
	11, // 22: proto.GetTransactionsService.GetTransactions:output_type -> proto.GetTransactionsMsgReply

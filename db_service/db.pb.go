...
var file_db_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x0b, 0x77, 0x65, 0x65, 0x6b, 0x6c, 0x79, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x32,
	...
	0x74, 0x61, 0x6c, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_db_proto_depIdxs = []int32{
	...
	0,  // 16: proto.UserSignUpService.SendUserSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 17: proto.OrgSignUpService.SendOrgSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 18: proto.CheckUserSignUpService.CheckUserSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 19: proto.CheckOrgSignUpService.CheckOrgSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 20: proto.ResendEmailAuthService.ResendEmailAuth:output_type -> proto.GlobalSuccessReply
	0,  // 21: proto.AuthLoginService.AuthLogin:output_type -> proto.GlobalSuccessReply
	0,  // 22: proto.BeginTransactionWHService.BeginTransactionWH:output_type -> proto.GlobalSuccessReply
	0,  // 23: proto.ConfirmTransferService.ConfirmTransfer:output_type -> proto.GlobalSuccessReply
	8,  // 24: proto.SearchOrgNameService.SearchOrgName:output_type -> proto.OrgNameReply
	0,  // 25: proto.TransferPDFService.TransferPDF:output_type -> proto.GlobalSuccessReply
	0,  // 26: proto.SaveLogoService.SaveLogo:output_type -> proto.GlobalSuccessReply
	12, // 27: proto.GetTransactionsService.GetTransactions:output_type -> proto.GetTransactionsMsgReply
	0,  // 28: proto.UpdateThresholdService.UpdateThreshold:output_type -> proto.GlobalSuccessReply
	16, // 29: proto.GetUsersOrgInfoService.GetUsersOrgInfo:output_type -> proto.UsersOrgInfoReply
	17, // 30: proto.GetUsersTotalsService.GetUsersTotals:output_type -> proto.UsersTotalsReply

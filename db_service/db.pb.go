...
var file_db_proto_rawDesc = []byte{
	...
	0x64, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0x55, 0x0a, 0x11, 0x55, 0x73, 0x65, 0x72, 0x53,
	...
	0x6f, 0x2e, 0x44, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x22, 0x00, 0x32, 0x47, 0x0a,
	0x0c, 0x47, 0x65, 0x74, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x73, 0x12, 0x37, 0x0a,
	...
	0x66, 0x65, 0x72, 0x73, 0x22, 0x00, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_db_proto_depIdxs = []int32{
	...
	16, // 28: proto.GetTransfers.GetDashboard:input_type -> proto.OrgToken
	...
	0,  // 32: proto.CheckOrgSignUpService.CheckOrgSignUp:output_type -> proto.GlobalSuccessReply
	0,  // 33: proto.ResendEmailAuthService.ResendEmailAuth:output_type -> proto.GlobalSuccessReply
	0,  // 34: proto.AuthLoginService.AuthLogin:output_type -> proto.GlobalSuccessReply
	0,  // 35: proto.BeginTransactionWHService.BeginTransactionWH:output_type -> proto.GlobalSuccessReply
	0,  // 36: proto.ConfirmTransferService.ConfirmTransfer:output_type -> proto.GlobalSuccessReply
	8,  // 37: proto.SearchOrgNameService.SearchOrgName:output_type -> proto.OrgNameReply
	0,  // 38: proto.TransferPDFService.TransferPDF:output_type -> proto.GlobalSuccessReply
	0,  // 39: proto.SaveLogoService.SaveLogo:output_type -> proto.GlobalSuccessReply
	12, // 40: proto.GetTransactionsService.GetTransactions:output_type -> proto.GetTransactionsMsgReply
	0,  // 41: proto.UpdateThresholdService.UpdateThreshold:output_type -> proto.GlobalSuccessReply
	17, // 42: proto.GetUsersOrgInfoService.GetUsersOrgInfo:output_type -> proto.UsersOrgInfoReply
	18, // 43: proto.GetUsersTotalsService.GetUsersTotals:output_type -> proto.UsersTotalsReply
	19, // 44: proto.GetUsersProfileService.GetUsersProfile:output_type -> proto.UsersProfileReply
	0,  // 45: proto.DeleteUsersBAService.DeleteUsersBA:output_type -> proto.GlobalSuccessReply
	0,  // 46: proto.UpdateUsersBAService.UpdateUsersBA:output_type -> proto.GlobalSuccessReply
	0,  // 47: proto.ValidNewAccService.ValidNewAcc:output_type -> proto.GlobalSuccessReply
	0,  // 48: proto.ValidPassService.ValidPass:output_type -> proto.GlobalSuccessReply
	0,  // 49: proto.ValidKeyService.ValidKey:output_type -> proto.GlobalSuccessReply
	0,  // 50: proto.SendForgotPassService.SendForgotPass:output_type -> proto.GlobalSuccessReply
	0,  // 51: proto.ForgotPassService.ForgotPass:output_type -> proto.GlobalSuccessReply
...
type GetTransfersClient interface {
	GetDashboard(ctx context.Context, in *OrgToken, opts ...grpc.CallOption) (*OrgsTransfers, error)
}
...
func (c *getTransfersClient) GetDashboard(ctx context.Context, in *OrgToken, opts ...grpc.CallOption) (*OrgsTransfers, error) {
...
type GetTransfersServer interface {
	GetDashboard(context.Context, *OrgToken) (*OrgsTransfers, error)
}
...
func (*UnimplementedGetTransfersServer) GetDashboard(context.Context, *OrgToken) (*OrgsTransfers, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDashboard not implemented")
}
...
func _GetTransfers_GetDashboard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GetTransfersServer).GetDashboard(ctx, req.(*OrgToken))
	}
	return interceptor(ctx, in, info, handler)
}

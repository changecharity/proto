...
var file_db_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x63, 0x68, 0x61, 0x72, 0x67, 0x65, 0x69, 0x64, 0x32, 0x55, 0x0a, 0x11, 0x55, 0x73,
...
var file_db_proto_depIdxs = []int32{
	...
	0, // 9: proto.CheckUserSignUpService.CheckUserSignUp:output_type -> proto.GlobalSuccessReply
	0, // 10: proto.CheckOrgSignUpService.CheckOrgSignUp:output_type -> proto.GlobalSuccessReply
	0, // 11: proto.AuthLoginService.AuthLogin:output_type -> proto.GlobalSuccessReply
	0, // 12: proto.BeginTransactionWHService.BeginTransactionWH:output_type -> proto.GlobalSuccessReply
	0, // 13: proto.ConfirmTransferService.ConfirmTransfer:output_type -> proto.GlobalSuccessReply
